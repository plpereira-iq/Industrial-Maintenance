...
const Equipo = () => {
  ...
  const handleHistory = () => {
    navigate(`/historial-equipo/${id}/${equipo.eqName}/${equipo.eqCode}`);
  };
  ...
  return (
    <div>
      <CustomNavbar />
      <div className="containerUnEquipo">
        <div className="card p-4 shadow-lg w-100">
          ...
          <div className="d-flex justify-content-between mt-4">
            ...
            <button className="btn btn-info" onClick={handleHistory}>Historial</button>
          </div>
        </div>
      </div>
    </div>
